...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('profile/index') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" required="">{{$user->alamat}}
                                </textarea>
